...
Parameters		ADC module pointer points to adc0 or adc1 register map base address.
...
/* Configure ADC as it will be used, but because ADC_SC1_ADCH is 31, the ADC will be inactive.  
Channel 31 is just disable function. There really is no channel 31. */
