 ...
 * Equipo: CALI
 *
 * Descripcion: Configuartion file of the "Grandpa´s Clock Scheduler" core
 * 
 * Comentarios: Here is the table to configure the tasks of the system
 */

#include "Core.h"
#include "Core_Config.h"
#include "..\PeriodicTasks\Periodic_Tasks.h"
#include "..\PeriodicTasks\Periodic_Tasks_Init.h"
...
const S_SCH_MANAGER_EXEC_TYPE cps_mngTaskList[SCHD_MANAGERS_NUMBER] = 
{
  /* Main function,                Init Function,                    Startup delay(ticks),  Execution Period(ticks),   Operation mode */
    ...
    {periodic_tasks_exec_10tks,    periodic_tasks_init_task_10tks,   30,                    30,                        ALL_MODES},
