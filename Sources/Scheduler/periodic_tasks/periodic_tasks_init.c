 ...
 * Equipo: CALI
 *
 * Descripcion: Definition of functions to initialize periodic tasks.
 * 
 * Comentarios: Add here the user initialization for the functionalities 
 * to execute periodically. Be congruent with periodic tasks contain.
 */
