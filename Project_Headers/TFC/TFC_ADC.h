...
/* NOTE: the following defines relate to the ADC register definitions and
	     the content follows the reference manual, using the same symbols. */
...
extern volatile uint8_t BatSenseADC_Value; //Variable externa
